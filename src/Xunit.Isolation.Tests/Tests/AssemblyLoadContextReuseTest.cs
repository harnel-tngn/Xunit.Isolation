...
public class AssemblyLoadContextReuseTest
{
    ...
    [IsolationContextConfig(createNewContext: false, isolationId: "AssemblyLoadContextReuseTest.A")]
    ...
    [IsolationContextConfig(createNewContext: false, isolationId: "AssemblyLoadContextReuseTest.B")]
